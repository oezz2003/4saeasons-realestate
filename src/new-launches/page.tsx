  ...
  const newLaunches = await Promise.all(
    compoundsData.map(async (c: WordPressCompound) => {
        return {
          ...
          developer: typeof c.acf.developer === 'object' && c.acf.developer ? (c.acf.developer.post_title || 'N/A') : (typeof c.acf.developer === 'string' ? c.acf.developer : 'N/A'),
          location: typeof c.acf.location === 'object' && c.acf.location ? c.acf.location.name : 'N/A',
        };
      })
  );
